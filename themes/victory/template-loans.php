    ...
    <div class="loans-wrapp">
        <div class="block-with-back-or">
            <ol>
                <li>
                    <div>
                        Кредитный потребительский кооператив «ПОБЕДА» выдаёт займы от 100 000 рублей юридическим и
                        физическим лицам.
                    </div>
                </li>
                <li>
        ...
        <div class="text-info-only">
            Займы выдаются только членам КПК «Победа», ознакомиться с порядком вступления в кооператив можно <a href="">здесь</a>.
            Член кооператива обязан солидарно с другими членами кредитного кооператива (пайщиками) нести субсидиарную
            ответственность по обязательствам кредитного кооператива в пределах невнесенной части дополнительного
            взноса.
        </div>
    </div>
</div>
